# -*- encoding: utf-8 -*-
# stub: dry-schema 1.11.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<dry-configurable>.freeze, ["~> 0.16", ">= 0.16"])
    s.add_runtime_dependency(%q<dry-core>.freeze, ["~> 0.9", ">= 0.9"])
    s.add_runtime_dependency(%q<dry-initializer>.freeze, ["~> 3.0"])
    s.add_runtime_dependency(%q<dry-logic>.freeze, ["~> 1.3"])
    ...
    s.add_dependency(%q<dry-configurable>.freeze, ["~> 0.16", ">= 0.16"])
    s.add_dependency(%q<dry-core>.freeze, ["~> 0.9", ">= 0.9"])
    s.add_dependency(%q<dry-initializer>.freeze, ["~> 3.0"])
    s.add_dependency(%q<dry-logic>.freeze, ["~> 1.3"])
    s.add_dependency(%q<dry-types>.freeze, ["~> 1.6"])
